...
export default function UseCaseList() {
  return (
    <div>
      <div className="my-5 px-lg-3 py-5 selago-background rad-5" id="meeting-assistant">
        <UseCase
          ...
          url={`${useCases.meetingAssistant.url}?embedded=true`}
          buttonText="I want more productive meetings"
          handleButtonClick={() => navigate(routes.public.register.path)}
        />
      </div>
      <div className="my-5 px-lg-3 py-5 snow-grey-background rad-5" id="project-planning">
        <UseCase
          ...
          url={`${useCases.projectPlanning.url}?embedded=true`}
          buttonText="I want more successful projects"
          handleButtonClick={() => navigate(routes.public.register.path)}
        />
      </div>
      <div className="my-5 px-lg-3 py-5 selago-background rad-5" id="productive-weeks">
        <UseCase
          ...
          url={`${useCases.productiveWeek.url}?embedded=true`}
          buttonText="I want more productive weeks"
          handleButtonClick={() => navigate(routes.public.register.path)}
        />
      </div>
      <div className="my-5 px-lg-3 py-5 snow-grey-background rad-5" id="crm">
        <UseCase
          heading="CRM"
          ...
          url={`${useCases.crm.url}?embedded=true`}
          buttonText="I want to manager customer relations better"
          handleButtonClick={() => navigate(routes.public.register.path)}
        />
      </div>
      <div className="my-5 px-lg-3 py-5 selago-background rad-5" id="fund-raising-assistant">
        <UseCase
          ...
          url={`${useCases.fundRaisingAssistant.url}?embedded=true`}
          buttonText="I want to improve my fundraising"
          handleButtonClick={() => navigate(routes.public.register.path)}
        />
      </div>
      <div className="my-5 px-lg-3 py-5 snow-grey-background rad-5" id="goal-tracker">
        <UseCase
          ...
          url={`${useCases.goalTracker.url}?embedded=true`}
          buttonText="I want to reach my goals"
          handleButtonClick={() => navigate(routes.public.register.path)}
        />
      </div>
      <div className="my-5 px-lg-3 py-5 selago-background rad-5" id="financial-task-manager">
        <UseCase
          ...
          url={`${useCases.financialTaskManager.url}?embedded=true`}
